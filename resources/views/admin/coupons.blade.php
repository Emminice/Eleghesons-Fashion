        ...
        <div class="table-card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="8" style="text-align:center;padding:32px;color:var(--gray)">No coupons yet</td></tr>
                    @endforelse
                </tbody>
            </table>
            <div style="padding:16px 20px;border-top:1px solid var(--border)">{{ $coupons->links() }}</div>
        </div>
        ...
        <div class="checkout-card">
            ...
            <form method="POST" action="{{ route('admin.coupons.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="code" placeholder="e.g. THREAD25" style="text-transform:uppercase" required>
