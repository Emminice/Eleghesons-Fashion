    ...
    <div style="margin-bottom:20px;display:flex;flex-direction:column;gap:12px">
        <form method="GET" action="{{ route('admin.products') }}"
            ...
            <select name="category"
                    style="padding:10px 14px;border:1.5px solid var(--border);border-radius:8px;
                           font-family:inherit;font-size:14px;background:white;min-width:160px">
        ...
        <div>
            <a href="{{ route('admin.products.create') }}"
               class="btn-primary"
               style="width:auto;padding:10px 18px;white-space:nowrap;display:inline-flex">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="chip" style="font-size:11px;white-space:nowrap">{{ $product->category->name }}</span></td>
